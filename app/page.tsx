    ...
    <div>
      ...
      <section className="border-t border-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6">
          <Link
            href="/test"
            className="group flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8 rounded-2xl border border-gray-100 bg-gray-50/60 hover:border-gray-200 transition-colors px-5 py-5 sm:px-7"
          >
            <div className="flex-1">
              ...
              <p className="text-gray-900 font-semibold">
                Descubre quién eres y el porqué de tus comportamientos.
              </p>
              <p className="text-sm text-gray-500 mt-0.5">
                25 preguntas de Sí o No · ~5 min · con lectura de IA al final
              </p>
            </div>
            <span className="inline-flex items-center justify-center h-11 px-6 shrink-0 bg-gray-900 text-white text-sm font-medium rounded-lg group-hover:bg-red-600 transition-colors">
              Hacer el test →
            </span>
          </Link>
        </div>
